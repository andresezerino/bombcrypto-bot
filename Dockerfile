...
#install DEPs
RUN git clone https://github.com/andresezerino/bombcrypto-bot.git /root/Desktop/bombcrypto-bot && pip install -r /root/Desktop/bombcrypto-bot/requirements.txt
